...
public class Excel {
	...
	*Description: method to get row data for specified column 
	*Author : Likhitha
	*/
    public static String getColumnData(String sheetName, String colName, int rowNum) throws IOException
    {
        ...
        try
        {
            fis = new FileInputStream(System.getProperty("user.dir")+"/"+ConfigManager.gsAutomationAutoSupportDocs+"TestData.xlsx");
  ...
  /*
	*Method :getTestData() 
	*Description: method to get all the clumn data for specified row.
	*Author : Likhitha
	*/
