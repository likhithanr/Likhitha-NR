...
public class ExtentManager extends TestListener{
	...
	*/
    public synchronized static ExtentReports createExtentReports() {
        ...
        ExtentSparkReporter reporter = new ExtentSparkReporter(htmlReportPath+".html").viewConfigurer().viewOrder().as(new ViewName[]{ViewName.DASHBOARD,ViewName.TEST,ViewName.CATEGORY,ViewName.AUTHOR,ViewName.EXCEPTION}).apply();
     ...
     /*
	*method :createExtentReportFileName() 
